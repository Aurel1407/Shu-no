...
export const cacheKeys = {
  products: (page?: number, limit?: number, search?: string) => 
    `products:${page || 'all'}:${limit || 'all'}:${search || 'all'}`,
  product: (id: number) => `product:${id}`,
  orders: (page?: number, limit?: number, search?: string, sortBy?: string, sortOrder?: string) => 
    `orders:${page || 'all'}:${limit || 'all'}:${search || 'all'}:${sortBy || 'all'}:${sortOrder || 'all'}`,
  order: (id: number) => `order:${id}`,
  users: (page?: number, limit?: number, search?: string, sortBy?: string, sortOrder?: string) => 
    `users:${page || 'all'}:${limit || 'all'}:${search || 'all'}:${sortBy || 'all'}:${sortOrder || 'all'}`,
  user: (id: number) => `user:${id}`,
  contacts: (page?: number, limit?: number, search?: string, sortBy?: string, sortOrder?: string) => 
    `contacts:${page || 'all'}:${limit || 'all'}:${search || 'all'}:${sortBy || 'all'}:${sortOrder || 'all'}`,
  contact: (id: number) => `contact:${id}`,
  pricePeriods: () => 'price_periods:all',
  settings: (key?: string) => `settings:${key || 'all'}`,
} as const;
