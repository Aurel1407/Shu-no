...
export default defineConfig(({ mode }) => ({
  ...
  test: {
    ...
    coverage: {
      ...
      all: true, // Collecter la couverture de tous les fichiers
      skipFull: false, // Ne pas skip les fichiers entièrement couverts
      ...
      output: {
        ...
        manualChunks(id) {
          ...
          if (
            ...
            id.includes("pages/Manage") ||
            id.includes("pages/Revenue") ||
            id.includes("pages/Occupancy")
          ) {
            return "chunk-admin";
          }
          ...
          if (
            id.includes("pages/Mentions") ||
            id.includes("pages/CGU") ||
            id.includes("pages/Confidentialite")
          ) {
            return "chunk-legal";
          }
